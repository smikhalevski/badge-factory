export const HttpRequestHeader = {
   ...
   * the header field (typically PUT or DELETE). Can be used when a user agent or firewall prevents PUT or DELETE
   * methods from being sent directly (note that this either a bug in the software component, which ought to be fixed,
   * or an intentional configuration, in which case bypassing it may be the wrong thing to do). Examples:
   ...
   * the example to the right is an XML file for an AT&T Samsung Galaxy S2.    x-wap-profile:
   * http://wap.samsungmobile.com/uaprof/SGH-I777.xml
   */
  X_WAP_PROFILE: 'X-Wap-Profile'
};

Object.freeze(HttpRequestHeader);

export const HttpResponseHeader = {
   ...
   * early HTTP versions. Has exactly the same functionality as standard Connection field.    Proxy-Connection:
   * keep-alive
   * @type {String}
   */
  ...
  /**
   * Server-side deep packet insertion of a unique ID identifying customers of Verizon Wireless, also known as
   * "perma-cookie" or "supercookie"    X-UIDH: ...
   */
  X_UIDH: 'X-UIDH',
  ...
  /**
   * Specifies which patch document formats this server supports    Accept-Patch: text/example,charset=utf-8   
   * Permanent
   */
   ...
   * filename for dynamic content. Quotes are necessary with special characters.    Content-Disposition: attachment,
  ...
  /**
   * The natural language or languages of the intended audience for the enclosed content    Content-Language: da   
   * Permanent
   */
  ...
  /**
   * The date and time that the message was sent (in "HTTP-date" format as defined by RFC 7231)    Date: Tue, 15 Nov
   * 1994 08:12:31 GMT    Permanent
   */
  DATE: 'Date',

  /**
   * An identifier for a specific version of a resource, often a message digest    ETag:
   ...
   * Expires: Thu, 01 Dec 1994 16:00:00 GMT    Permanent: standard
   */
  EXPIRES: 'Expires',

  /**
   * The last modified date for the requested object (in "HTTP-date" format as defined by RFC 7231)    Last-Modified:
   * Tue, 15 Nov 1994 12:45:26 GMT    Permanent
   */
  LAST_MODIFIED: 'Last-Modified',

  /**
   * Used to express a typed relationship with another resource, where the relation type is defined by RFC 5988   
   * Link: </feed>, rel="alternate"    Permanent
   */
  LINK: 'Link',
  ...
  /**
   * This field is supposed to set P3P policy, in the form of P3P:CP="your_compact_policy". However, P3P did not take
   * off, most browsers have never fully implemented it, a lot of websites set this field with fake policy text, that
   * was enough to fool browsers the existence of P3P policy and grant permissions for third party cookies.    P3P:
   * CP="This is not a P3P policy! See http://www.google.com/support/accounts/bin/answer.py?hl=en&answer=151657 for
   * more info."    Permanent
   * @type {string}
   */
  P3P: 'P3P',
  ...
  /**
   * Implementation-specific fields that may have various effects anywhere along the request-response chain.    Pragma:
   * no-cache    Permanent
   */
  PRAGMA: 'Pragma',
  ...
  /**
   * HTTP Public Key Pinning, announces hash of website's authentic TLS certificate    Public-Key-Pins:
   * max-age=2592000, pin-sha256="E9CZ9INDbd+2eRQozYqqbQ2yXLVKB9+xcprMF+44U1g=",    Permanent
   */
  PUBLIC_KEY_PINS: 'Public-Key-Pins',

  /**
   * Used in redirection, or when a new resource has been created. This refresh redirects after 5 seconds.    Refresh:
   * 5, url=http://www.w3.org/pub/WWW/People.html    Proprietary and non-standard: a header extension introduced by
  ...
  /**
   * CGI header field specifying the status of the HTTP response. Normal HTTP responses use a separate "Status-Line"
   * instead, defined by RFC 7230.    Status: 200 OK    Not listed as a registered field name
   */
  STATUS: 'Status',

  /**
   * A HSTS Policy informing the HTTP client how long to cache the HTTPS only policy and whether this applies to
   * subdomains.    Strict-Transport-Security: max-age=16070400, includeSubDomains    Permanent: standard
   */
  STRICT_TRANSPORT_SECURITY: 'Strict-Transport-Security',

  /**
   * The Trailer general field value indicates that the given set of header fields is present in the trailer of a
   * message encoded with chunked transfer coding.    Trailer: Max-Forwards    Permanent
   */
  TRAILER: 'Trailer',

  /**
   * The form of encoding used to safely transfer the entity to the user. Currently defined methods are: chunked,
   * compress, deflate, gzip, identity.    Transfer-Encoding: chunked    Permanent
   */
   ...
   * rather than requesting a fresh one from the origin server.    Vary: *    Permanent
   */
  VARY: 'Vary',

  /**
   * Informs the client of proxies through which the response was sent.    Via: 1.0 fred, 1.1 example.com (Apache/1.1) 
   *   Permanent
   */
  VIA: 'Via',
  ...
  /**
   * Indicates the authentication scheme that should be used to access the requested entity.    WWW-Authenticate: Basic
   *    Permanent
   */
   ...
   * allow-from - allow from specified location, allowall - non-standard, allow from any location    X-Frame-Options:
   * deny    Obsolete
   */
   ...
   * content-type. This also applies to Google Chrome, when downloading extensions.    X-Content-Type-Options: nosniff
   */
  X_CONTENT_TYPE_OPTIONS: 'X-Content-Type-Options',

  /**
   * specifies the technology (e.g. ASP.NET, PHP, JBoss) supporting the web application (version details are often in
   * X-Runtime, X-Version, or X-AspNet-Version)    X-Powered-By: PHP/5.4.0
   */
  X_POWERED_BY: 'X-Powered-By',

  /**
   * Recommends the preferred rendering engine (often a backward-compatibility mode) to use to display the content.
   * Also used to activate Chrome Frame in Internet Explorer.    X-UA-Compatible: IE=EmulateIE7
  ...
  /**
   * Provide the duration of the audio or video in seconds, only supported by Gecko browsers    X-Content-Duration:
   * 42.666
   */
  X_CONTENT_DURATION: 'X-Content-Duration'
};

Object.freeze(HttpResponseHeader);
